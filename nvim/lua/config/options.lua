...
opt.numberwidth = 6 -- Reduce the number column width to bring code closer to the gutter
...
vim.cmd([[
  highlight LineNr guifg=#585858 guibg=#000000
  highlight CursorLineNr guifg=white guibg=#333333
]])
